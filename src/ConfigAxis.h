...
inline void readUserAxes(Joystick_& joystick) {
    // Use the global AnalogAxisManager to read all axes (handles both analog pins and ADS1115)
    // Reference the global axis manager defined in main.cpp
    extern AnalogAxisManager g_axisManager;
    static bool configured = false;
    
    // Configure axis manager on first run
    if (!configured) {
        #ifdef USE_AXIS_X
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_X, AXIS_X_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_X, AXIS_X_MIN, AXIS_X_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_X, AXIS_X_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_X, AXIS_X_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_X, AXIS_X_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_X, AXIS_X_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_X, true);
        #endif
        
        #ifdef USE_AXIS_Y
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_Y, AXIS_Y_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_Y, AXIS_Y_MIN, AXIS_Y_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_Y, AXIS_Y_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_Y, AXIS_Y_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_Y, AXIS_Y_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_Y, AXIS_Y_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_Y, true);
        #endif
        
        #ifdef USE_AXIS_Z
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_Z, AXIS_Z_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_Z, AXIS_Z_MIN, AXIS_Z_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_Z, AXIS_Z_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_Z, AXIS_Z_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_Z, AXIS_Z_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_Z, AXIS_Z_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_Z, true);
        #endif
        
        #ifdef USE_AXIS_RX
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_RX, AXIS_RX_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_RX, AXIS_RX_MIN, AXIS_RX_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_RX, AXIS_RX_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_RX, AXIS_RX_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_RX, AXIS_RX_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_RX, AXIS_RX_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_RX, true);
        #endif
        
        #ifdef USE_AXIS_RY
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_RY, AXIS_RY_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_RY, AXIS_RY_MIN, AXIS_RY_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_RY, AXIS_RY_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_RY, AXIS_RY_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_RY, AXIS_RY_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_RY, AXIS_RY_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_RY, true);
        #endif
        
        #ifdef USE_AXIS_RZ
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_RZ, AXIS_RZ_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_RZ, AXIS_RZ_MIN, AXIS_RZ_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_RZ, AXIS_RZ_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_RZ, AXIS_RZ_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_RZ, AXIS_RZ_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_RZ, AXIS_RZ_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_RZ, true);
        #endif
        
        #ifdef USE_AXIS_S1
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_S1, AXIS_S1_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_S1, AXIS_S1_MIN, AXIS_S1_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_S1, AXIS_S1_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_S1, AXIS_S1_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_S1, AXIS_S1_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_S1, AXIS_S1_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_S1, true);
        #endif
        
        #ifdef USE_AXIS_S2
            g_axisManager.setAxisPin(AnalogAxisManager::AXIS_S2, AXIS_S2_PIN);
            g_axisManager.setAxisRange(AnalogAxisManager::AXIS_S2, AXIS_S2_MIN, AXIS_S2_MAX);
            g_axisManager.setAxisFilterLevel(AnalogAxisManager::AXIS_S2, AXIS_S2_FILTER_LEVEL);
            g_axisManager.setAxisEwmaAlpha(AnalogAxisManager::AXIS_S2, AXIS_S2_EWMA_ALPHA);
            g_axisManager.setAxisDeadbandSize(AnalogAxisManager::AXIS_S2, AXIS_S2_DEADBAND);
            g_axisManager.setAxisResponseCurve(AnalogAxisManager::AXIS_S2, AXIS_S2_CURVE);
            g_axisManager.enableAxis(AnalogAxisManager::AXIS_S2, true);
        #endif
    ...
    g_axisManager.readAllAxes();
    
    // Set joystick values for all enabled axes
    #ifdef USE_AXIS_X
        int32_t processedXVal = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_X);
        joystick.setAxis(AnalogAxisManager::AXIS_X, processedXVal);
    #endif
    
    #ifdef USE_AXIS_Y
        int32_t processedYVal = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_Y);
        joystick.setAxis(AnalogAxisManager::AXIS_Y, processedYVal);
    #endif
    
    #ifdef USE_AXIS_Z
        int32_t processedZVal = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_Z);
        joystick.setAxis(AnalogAxisManager::AXIS_Z, processedZVal);
    #endif
    
    #ifdef USE_AXIS_RX
        int32_t processedRxVal = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_RX);
        joystick.setAxis(AnalogAxisManager::AXIS_RX, processedRxVal);
    #endif
    
    #ifdef USE_AXIS_RY
        int32_t processedRyVal = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_RY);
        joystick.setAxis(AnalogAxisManager::AXIS_RY, processedRyVal);
    #endif
    
    #ifdef USE_AXIS_RZ
        int32_t processedRzVal = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_RZ);
        joystick.setAxis(AnalogAxisManager::AXIS_RZ, processedRzVal);
    #endif
    
    #ifdef USE_AXIS_S1
        int32_t processedS1Val = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_S1);
        joystick.setAxis(AnalogAxisManager::AXIS_S1, processedS1Val);
    #endif
    
    #ifdef USE_AXIS_S2
        int32_t processedS2Val = g_axisManager.getAxisValue(AnalogAxisManager::AXIS_S2);
