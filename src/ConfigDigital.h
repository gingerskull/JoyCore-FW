...
constexpr LogicalInput logicalInputs[] = {
  ...
  { INPUT_PIN, { .pin = {8, 3, NORMAL, 0} } },    // Normal button on pin 4
  { INPUT_PIN, { .pin = {9, 4, NORMAL, 0} } },    // Reversed button on same pin 4
  ...
  //{ INPUT_SHIFTREG, { .shiftreg = {0, 0, 11, ENC_A, 0} }, FOUR0 },
  //{ INPUT_SHIFTREG, { .shiftreg = {0, 1, 12, ENC_B, 0} }, FOUR0 },
  //{ INPUT_SHIFTREG, { .shiftreg = {0, 2, 13, NORMAL, 0} } },    // Normal button on shift reg 0, bit 2
  //{ INPUT_SHIFTREG, { .shiftreg = {0, 2, 16, NORMAL, 1} } },    // Reversed button on same shift reg 0, bit 2
  //{ INPUT_SHIFTREG, { .shiftreg = {0, 3, 14, NORMAL, 0} } },
  //{ INPUT_SHIFTREG, { .shiftreg = {0, 4, 15, NORMAL, 0} } }
  // ...add more as needed...
};